          ...
          <>
            <div className="overflow-hidden rounded-lg border border-border/60 bg-muted/20">
              <iframe
                ...
                className="h-[50vh] w-full sm:h-[60vh] lg:h-[65vh]"
              />
            </div>
        ...
        {url && (
          <>
            <div className="flex justify-center overflow-hidden rounded-lg border border-border/60 bg-muted/20 p-2">
              ...
              <img src={url} alt={titulo ?? "Foto del activo"} className="max-h-[50vh] max-w-full object-contain sm:max-h-[60vh] lg:max-h-[65vh]" />
            </div>
            <div className="flex justify-end gap-2">
              <Button type="button" variant="outline" onClick={onClose}>
                Cerrar
