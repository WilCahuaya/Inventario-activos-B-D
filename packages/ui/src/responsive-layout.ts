/** Clases de layout compartidas (definidas en globals.css + utilidades Tailwind). */

export const panelPageClass = "panel-page";

export const panelMainPaddingClass = "panel-main-padding";

export const panelShellHeaderClass = "panel-shell-header";
